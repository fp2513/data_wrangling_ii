...
There is an issue with the data we imported; first row (there is this
NOTE) Slice function allows to select rows by number
...
If there are multiple tables how to tell it which you want? (first
...
recognise what we want on the page
